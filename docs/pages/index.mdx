...
Analog Design Workspace for Sky130 PDK

<Cards>
	<a href="/Analog_Layout_Guide" className="nextra-card">
		<h3>Analog Layout Guide</h3>
		<p>Best practices for analog layout, including device matching, common-centroid techniques, and parasitic mitigation to ensure robust, circuit design.</p>
	</a>
	<a href="/Power_Grids" className="nextra-card">
		<h3>Power Grids in VLSI</h3>
		<p>Learn how to design and implement power distribution networks (PDNs) using power straps, rings, and on-chip decoupling to maintain supply integrity for sensitive analog circuits.</p>
	</a>
	<a href="/Running_DRC" className="nextra-card">
		<h3>Running DRC</h3>
		<p>Step-by-step guide for running Design Rule Check (DRC) using the Physical Verification System (PVS) in Cadence Virtuoso with the Sky130 PDK.</p>
	</a>
	<a href="/impedance-matching" className="nextra-card">
		<h3>Impedance Matching</h3>
		<p>A guide to impedance matching for voltage, current, and power. Covers two-port models, optimal impedances for various amplifier types, and conjugate matching for RF systems.</p>
	</a>
	<a href="/Git_Guide" className="nextra-card">
		<h3>Git Guide</h3>
		<p>A guide to the Git workflow and branching strategy for the TVIP Analog Workspace.</p>
	</a>
</Cards>
