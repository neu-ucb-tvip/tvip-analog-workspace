...
<Cards>
	<a href="/tvip-analog-workspace/Analog_Layout_Guide" className="nextra-card">
		<h3>Analog Layout Guide</h3>
		<p>Matching, common‑centroid, routing, and guard rings.</p>
	</a>
	<a href="/tvip-analog-workspace/Power_Grids" className="nextra-card">
		<h3>Power Grids in VLSI</h3>
		<p>PDN straps, rings, decaps, and IR/EM tips.</p>
	</a>
	<a href="/tvip-analog-workspace/Running_DRC" className="nextra-card">
		<h3>Running DRC</h3>
		<p>PVS presets, run directory, and common fixes.</p>
	</a>
	<a href="/tvip-analog-workspace/impedance-matching" className="nextra-card">
		<h3>Impedance Matching</h3>
		<p>Two‑port models and conjugate matching basics.</p>
	</a>
	<a href="/tvip-analog-workspace/Git_Guide" className="nextra-card">
		<h3>Git Guide</h3>
