...
![planar body contact](/images/planar_body_contact.png)
...
![planar double sided body contact](/images/planar_double_sided_body_contact.png)
...
![planar guard ring](/images/planar_guard_ring.png)
...
![asymmetric mosfet](/images/asymmetric_mosfet.png)
...
![5T Input Pair Net Highlighting](/images/common_centroid_5t_input_pair.png)
...
![5T Input Pair Common Centroid](/images/common_centroid_5t_input_pair_centroid.png)
...
![common centroid arrays](/images/common_centroid_arrays.png)
...
![mirror matching](/images/mirror_matching.png)
...
![mfc capacitors](/images/mfc_capacitors.png)
...
![matched resistors](/images/matched_resistors.png)
...
![ir drop gate resistance](/images/ir_drop_gate_resistance.png)

Image from [F. Maloberti, "Layout of Analog CMOS Integrated Circuits" (Part 2)](/resources/Maloberti_Layout_of_Analog_CMOS_ICs.pdf).

### Matching IR drop

![matching connections](/images/matching_connections.png)
