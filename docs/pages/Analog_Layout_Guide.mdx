...
<BasePathImage src="/images/planar_body_contact.png" alt="planar body contact" width="500px" />
...
<BasePathImage src="/images/planar_double_sided_body_contact.png" alt="planar double sided body contact" width="500px" />
...
<BasePathImage src="/images/planar_guard_ring.png" alt="planar guard ring" width="500px" />
...
<BasePathImage src="/images/asymmetric_mosfet.png" alt="asymmetric mosfet" width="600px" />
...
<BasePathImage src="/images/common_centroid_5t_input_pair.png" alt="5T Input Pair Net Highlighting" width="600px" />
...
<BasePathImage src="/images/common_centroid_5t_input_pair_centroid.png" alt="5T Input Pair Common Centroid" width="600px" />
...
<BasePathImage src="/images/common_centroid_arrays.png" alt="common centroid arrays" width="700px" />
...
<BasePathImage src="/images/mirror_matching.png" alt="mirror matching" width="600px" />
...
<BasePathImage src="/images/mfc_capacitors.png" alt="mfc capacitors" width="600px" />
...
<BasePathImage src="/images/matched_resistors.png" alt="matched resistors" width="600px" />
...
<BasePathImage src="/images/ir_drop_gate_resistance.png" alt="ir drop gate resistance" width="600px" />

Image from [F. Maloberti, "Layout of Analog CMOS Integrated Circuits" (Part 2)](/resources/Maloberti_Layout_of_Analog_CMOS_ICs.pdf).

### Matching IR drop

<BasePathImage src="/images/matching_connections.png" alt="matching connections" width="600px" />
