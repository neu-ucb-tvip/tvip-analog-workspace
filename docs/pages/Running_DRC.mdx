...
<img src="/tvip-analog-workspace/images/running_drc/virtuoso_layout_pvs_run_drc.png" alt="virtuoso layout pvs run drc" width="600px" />

On the menu bar of the PVS DRC GUI, click `File` -> `Load Presets`.

<img src="/tvip-analog-workspace/images/running_drc/pvs_load_preset.png" alt="pvs load preset" width="400px" />

In the file dialog, navigate to the `Sky130_DRC` directory and select `sky130.virtuoso6.drc_preset`.

<img src="/tvip-analog-workspace/images/running_drc/load_preset_sky130.png" alt="load preset sky130" width="600px" />
